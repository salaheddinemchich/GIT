...
/**
 * REST entry points to inspect and refund payments — exercises the payments
 * side of the choreography end to end.
 */
@Path("/payments")
public class PaymentResource {
    ...
    public Response refund(@PathParam("orderId") String orderId) {
        ...
        pubsub.publish(PubSubConfig.topic(PubSubConfig.PAYMENTS_REFUNDED_TOPIC), refunded.toMessage());
